@extends('allwebviews.layouts.master')
...
$firebase = new \App\Library\Notifications\Firebase();
$push = new \App\Library\Notifications\PushNotification();
...
<div class="container">
    ...
    <form class="pure-form pure-form-stacked" method="get">
        <fieldset>
            ...
            <input type="text" id="title1" name="title" class="pure-input-1-2" placeholder="Enter title" value="aaaaa">

            <label for="message1">Message</label>
            <textarea class="pure-input-1-2" name="message" id="message1" rows="5" placeholder="Notification message!">bbbbbb{{time()}}</textarea>
